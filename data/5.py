...
prob_matrix = np.array([
    ...
    [0.82,  0.10,   0.02,  0.02,  0.02,  0.02],
    [0.18,  0.72,   0.02,  0.02,  0.02,  0.04],
    [0.28,  0.10,   0.55,  0.02,  0.02,  0.03],
    [0.20,  0.05,   0.02,  0.68,  0.02,  0.03],
    [0.12,  0.05,   0.02,  0.02,  0.78,  0.01],
    [0.30,  0.05,   0.02,  0.02,  0.01,  0.60]
])
...
plt.title('Confusion Matrix: Llama4-Maverick', fontsize=18, pad=20, weight='bold')
...
print(f"ADHD Accuracy: {cm_data[2,2] / cm_data[2,:].sum():.2%} (Optimized)")
print(f"ADHD Misclassified as Anxiety: {cm_data[2,0] / cm_data[2,:].sum():.2%} (Bias still visible)")